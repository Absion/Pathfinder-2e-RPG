...
func _seed_data():
	...
	db.query("INSERT OR IGNORE INTO actions (id, name, cost, traits, requirements, trigger, description, script_path) VALUES 
		...
		('avoid_notice', 'Avoid Notice', '1', '[]', '', '', 'You attempt to move stealthily during exploration.', 'res://scripts/actions/pf_action_exploration.gd'),
		...
		('delay', 'Delay', 'free', '[]', 'Your turn begins and you haven''t acted yet.', '', 'You wait to take your turn.', 'res://scripts/actions/pf_action_generic.gd'),
		...
		('escape', 'Escape', '1', '[\"attack\"]', 'You are grabbed, immobilized, or restrained.', '', 'You attempt to escape.', 'res://scripts/actions/pf_action_generic.gd'),
		...
		('point_out', 'Point Out', '1', '[\"auditory\",\"manipulate\",\"visual\"]', '', '', 'You indicate an unseen creature to your allies.', 'res://scripts/actions/pf_action_generic.gd'),
		...
		('seek', 'Seek', '1', '[\"concentrate\",\"secret\"]', '', '', 'You scan an area for unseen creatures or objects.', 'res://scripts/actions/pf_action_generic.gd'),
		('sense_motive', 'Sense Motive', '1', '[\"concentrate\",\"secret\"]', '', '', 'You try to tell whether a creature''s behavior is abnormal.', 'res://scripts/actions/pf_action_generic.gd'),
