...
func before_all():
	...
	db.query("REPLACE INTO class_progressions (class_id, level, granted_features, granted_feat_slots, granted_spells) VALUES ('wizard', 2, '[]', '[\"class\", \"skill\"]', '{\"spells_learned\": 2}')")
	db.query("REPLACE INTO class_progressions (class_id, level, granted_features, granted_feat_slots, granted_spells) VALUES ('wizard', 3, '[]', '[\"skill\"]', '{}')")
