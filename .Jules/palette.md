...
## 2026-08-05 - Disable Dropdown Placeholders
**Learning:** Users might accidentally submit default placeholder options (like '--- Select ---') if they are not explicitly disabled, leading to invalid states or confusion.
**Action:** Always set the placeholder option at index 0 to disabled using `set_item_disabled(0, true)` in Godot OptionButtons.
