...
## 2024-05-24 - Disable Dropdown Placeholders
**Learning:** Placeholders in OptionButtons ("--- Select ---") can be accidentally submitted if not disabled, confusing users.
**Action:** Always explicitly disable the first index (`set_item_disabled(0, true)`) in Godot OptionButtons for placeholder items.
