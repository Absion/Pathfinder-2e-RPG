...
- [ ] **Flanking System**: Raycasting math to determine if an enemy is flanked by two allies, automatically applying the *Off-Guard* condition.
- [ ] **Cover System**: 3D raycasting collisions to determine *Lesser*, *Standard*, and *Greater* cover, automatically applying circumstance bonuses to AC and Reflex saves.
